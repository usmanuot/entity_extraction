package com.example.entitiyextractionjava;
...
class ModelsActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    listView.setOnItemClickListener(
        (parent, view, position, id) -> {
          Intent intent = new Intent(ModelsActivity.this, MainActivity.class);
  ...
  class LanguageAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      if (convertView == null) {
        convertView =
            LayoutInflater.from(ModelsActivity.this).inflate(R.layout.list_item, parent, false);
      }
